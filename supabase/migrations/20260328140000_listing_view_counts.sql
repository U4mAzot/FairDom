-- Liczniki wyświetleń ogłoszeń (slug = segment URL /properties/[slug]).
...
-- Atomowy insert +1 lub update; zwraca nową wartość (dla API).
...
-- Odświeżenie cache PostgREST (API), żeby od razu widać było tabelę i RPC.
